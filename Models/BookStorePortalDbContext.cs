...
public partial class BookStorePortalDbContext : DbContext
{
    public BookStorePortalDbContext()
    {
    }

    public BookStorePortalDbContext(DbContextOptions<BookStorePortalDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=IRFANA\\SQLSERVER2022;Initial Catalog=Book_Store_Portal_Db;User Id=sa;Password=user123;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Discount>(entity =>
        {
            ...
            entity.Property(e => e.Dicounttype)
                .HasMaxLength(50)
                .IsUnicode(false)
